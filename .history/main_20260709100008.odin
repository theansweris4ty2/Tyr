...
tool_bar: Tool_Bar = {{0, 0, WINDOW_WIDTH, 50}, {Button{{10, 0, 200, 50}, WHEAT_GOLD, "New Game", 30}, Button{{0, 475, 200, 50}, WHEAT_GOLD, "Saved Game", 10}, Button{{400, 550, 200, 50}, WHEAT_GOLD, "Quit", 75}}}
