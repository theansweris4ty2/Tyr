...
for &tile in tile_map{
    for i in 0..=len(tile_map) -2 {
        if tile_map[i].rect.x + tile_map[i].rect.w >= tile_map[i+1].rect.x && tile_map[i].rect.x <= tile_map[i+1].rect.x + tile_map[1+1].rect.w && tile_map[i].rect.y + tile_map[i].rect.h >= tile_map[i+1].rect.y && tile_map[i].rect.y <= tile_map[i+1].rect.y + tile_map[i+1].rect.h || tile_map[i].rect.x <= 0 || tile_map[i].rect.y <= 0 || tile_map[i.] {
