...
player_stats:= fmt.tprintf("grain: %d Lumber: %d Ore: %d Soldiers: %d Treasury: %d", player_ptr.grain, player_ptr.lumber, player_ptr.ore, len(player_ptr.troops), player_ptr)
