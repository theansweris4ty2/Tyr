...
//     }
        ...
        case "Infantry":
            ...
            troop.recruitment_cost 
            append(&p_ptr.troops, Troop_Tile{{}, infantry, 2, 1, "infantry", 2})
        case "Crossbow":
            append(&p_ptr.troops, Troop_Tile{{}, crossbowmen, 4, 1, "crossbow", 3})
        case "Cavalry":
            append(&p_ptr.troops, Troop_Tile{{}, cavalry, 6, 1, "cavalry", 5})
    }
        }
    }
}
