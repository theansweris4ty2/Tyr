...
menu_buttons: [dynamic; 20]Button = {Button{{menu1_rect.x + 10, menu1_rect.y + 10, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{menu1_rect.x + 10, menu1_rect.y + 70, 200, 50}, WHEAT_GOLD, "Battle", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 130, 200, 50}, WHEAT_GOLD, "Quit", 75}, Button{{menu1_rect.x + 10, menu1_rect.y + 190, 200, 50}, WHEAT_GOLD, "Produce", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 250, 200, 50}, WHEAT_GOLD, "Spy", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 310, 200, 50}, WHEAT_GOLD, "Build", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 370, 200, 50}, WHEAT_GOLD, "Tax", 50},  Button{{menu1_rect.x + 190, menu1_rect.y + 430, 200, 50}, WHEAT_GOLD, "Move", 50}, Button{{menu1_rect.x + 400, menu1_rect.y + 430, 200, 50}, WHEAT_GOLD, "Recruit", 50}, Button{{menu1_rect.x + 80, menu1_rect.y + 500, 200, 50}, WHEAT_GOLD, "Infantry", 40}, Button{{menu1_rect.x + 290, menu1_rect.y + 500, 200, 50}, WHEAT_GOLD, "Crossbow", 30}, Button{{menu1_rect.x + 500, menu1_rect.y + 500, 200, 50}, WHEAT_GOLD, "Cavalry", 40}, Button{{menu1_rect.x + 190, menu1_rect.y + 430, 200, 50}, WHEAT_GOLD, "Buy", 50}, Button{{menu1_rect.x + 400, menu1_rect.y + 430, 200, 50}, WHEAT_GOLD, "Sell", 50}, Button{{menu1_rect.x + 80, menu1_rect.y + 500, 200, 50}, WHEAT_GOLD, "Grain", 40}, Button{{menu1_rect.x + 290, menu1_rect.y + 500, 200, 50}, WHEAT_GOLD, "Crossbow", 30}, Button{{menu1_rect.x + 500, menu1_rect.y + 500, 200, 50}, WHEAT_GOLD, "Cavalry", 40}}
