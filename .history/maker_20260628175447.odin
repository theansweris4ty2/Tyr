...
for &tile in farm_tiles {
    ...
    for &next_tile in farm_tiles {
        if tile.rect.x + tile.rect.w >= next_tile.x && tile.rect.x <= next_tile.rect.x + next_title.w && tile.rect.y + tile.rect. >= next_tile.x && tile.rect.x <= next_tile.rect.x + next_title.w
    }
}
