...
start_buttons: [3]Button = {Button{{550, 400, 200, 50}, WHEAT_GOLD, "New Game", 30}, Button{{550, 475, 200, 50}, WHEAT_GOLD, "Saved Game", 10}, Button{{550, 550, 200, 50}, WHEAT_GOLD, "Quit", 75}}
menu1: Menu = {{200, 200, 400, 400}, start_buttons}
