...
*/
sell_goods :: proc(player_ptr: ^Player, goods: string, amount: i32, price: i32){
    price: i32
    switch goods {
        case "grain":
            player_ptr.grain -= amount
            player_ptr.treasury += (price * amount)
        case "ore": 
...
buy_goods :: proc(player_ptr: ^Player, goods: string, amount: i32, price: i32){

    player_ptr.treasury -= market[goods] * amount
    switch goods {
        case "grain":
            player_ptr.grain += amount
            fmt.println(player_ptr.treasury
        case "ore": 
            player_ptr.ore += amount
        case "lumber":
            player_ptr.lumber += amount
