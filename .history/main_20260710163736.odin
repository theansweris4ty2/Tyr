...
toolbar: Toolbar = {{0, 0, WINDOW_WIDTH, 60}, {Button{{200, 5, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{420, 5, 200, 50}, WHEAT_GOLD, "Battle", 50}, Button{{640, 5, 200, 50}, WHEAT_GOLD, "Quit", 75}}}
toolbar2: Toolbar = {{0, 650, WINDOW_WIDTH, 60}, {Button{{200, 650, 200, 50}, WHEAT_GOLD, "Infantry", 10}, Button{{420, 655, 200, 50}, WHEAT_GOLD, "Crossbowmen", 10}, Button{{640, 650, 200, 50}, WHEAT_GOLD, "Cavalry", 10}}}
