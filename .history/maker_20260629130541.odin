...
for &tile in tile_map{
    for i in 0..=len(tile_map) -2 {
        if i.rect.x + i.rect.w >= tile_map[i+1].rect.x && i.rect.x <= tile_map[i+1].rect.x + tile_.rect.w && tile.rect.y + tile.rect.h >= next_tile.rect.y && tile.rect.y <= next_tile.rect.y + next_tile.rect.h {
    // //         tile.x_velocity = 0
    // //         tile.y_velocity = 0
    // //         next_tile.y_velocity = 0
    // //         next_tile.x_velocity = 0
