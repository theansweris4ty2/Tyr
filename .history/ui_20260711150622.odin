...
menu_buttons: [3]Button = {Button{{menu1.rect.x + 10, menu1.rect.y + 10, 200, 50}, WHEAT_GOLD, "New Game", 30}, Button{{menu1.rect.x + 10, menu1.rect.y + 70, 200, 50}, WHEAT_GOLD, "Saved Game", 10}, Button{{500, 550, 200, 50}, WHEAT_GOLD, "Quit", 75}}
