...
toolbar: Toolbar = {{0, 0, WINDOW_WIDTH, 50}, {Button{{200, 0, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{420, 0, 200, 50}, WHEAT_GOLD, "Battle", 10}, Button{{6, 0, 200, 50}, WHEAT_GOLD, "Quit", 75}}}
