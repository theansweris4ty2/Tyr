...
recruit_menu:= Menu{{200, 800, 600, 600}, {{Button{{recruit_menu_rect.x + 10, recruit_menu_rect.y + 10, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{recruit_menu_rect.x + 10, menu_recruitrect.y + 70, 200, 50}, WHEAT_GOLD, "Battle", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 130, 200, 50}, WHEAT_GOLD, "Quit", 75}}
