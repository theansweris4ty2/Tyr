...
menu_buttons: [3]Button = {Button{{menu1.rect.x + 1, 400, 200, 50}, WHEAT_GOLD, "New Game", 30}, Button{{500, 475, 200, 50}, WHEAT_GOLD, "Saved Game", 10}, Button{{500, 550, 200, 50}, WHEAT_GOLD, "Quit", 75}}
