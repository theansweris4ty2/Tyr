...
build_board :: proc(texture: ) -> [dynamic]Tile{
    tiles : [dynamic]Tile
    start_y: f32 = 500
    start_x: f32 = 300
    x: f32
    ...
    for i in 0..=4{
        ...
        for h in 0..=i {
            y = f32(h*100) + start_y
            append(&tiles, Tile{{x, y, TILE_WIDTH, TILE_HEIGHT}, " ", 0,  {}, false, false, false {rl.BLACK, 1}})
        }
        start_y -= 50
        start_x += 50
    }
    ...
    for i in 0..=5{
        ...
        for h in 0..=columns{
            y = f32(h*100) + start_y
            append(&tiles, Tile{"", rl.Rectangle{x, y, 100, 100}, " ", 0,  {}, false, false, false})
        }
        start_y += 50
        columns -= 1   
    }
...
draw_board::proc(tiles:[dynamic]Tile){
    ...
    rl.DrawRectangleLines(i32(tile.rect.x), i32(tile.rect.y), i32(tile.rect.width), i32(tile.rect.height), rl.BLACK)
} 
}