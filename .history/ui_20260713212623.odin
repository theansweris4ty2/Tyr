...
/* Add buttons to battle_buttons for additional battle actions including placement of troops which should fix issue with accidental placement. Also, add print of troops stats
*/
