...
*/
sell_goods :: proc(player_ptr: ^Player, goods: i32, amount: i32){

    player_ptr.treasury += goods * amount
}

buy_goods :: proc(player_ptr: ^Player, goods: i32, amount: i32, market: Market){
