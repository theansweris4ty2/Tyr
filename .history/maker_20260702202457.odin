...
seed :: proc(texture: k2.Texture, texture2: k2.Texture, texture3: k2.Texture) -> ([dynamic; 8]Tile, [dynamic; 45]Tile, [dynamic; 45]Tile){
core_tiles : [dynamic]Tile
water : [dynamic; 8]Tile 
forests : [dynamic; 45]Tile
farms: [dynamic; 45]Tile
mines: [50]Tile
military: [50]Tile
x: f32
y: f32
...
for i in 0..<8 {
    ...
    append(&core_tiles, Tile{{x, y, f32(50), f32(50)}, "water", texture, 0, 0})
}
 for i in 0..<45 {
    x = rand.float32_range(0, 1600) 
    y = rand.float32_range(0, 1000) 
...
spread :: proc(farm_tiles: [dynamic; 45]Tile, forest_tiles:[dynamic; 45]Tile, water_tiles: [dynamic; 8]Tile) -> [dynamic]Tile{
