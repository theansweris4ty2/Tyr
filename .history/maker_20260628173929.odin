...
for i in 0..=9 {
 ...
 for i in 0..=49 {
    x = rand.float32_range(10, 1500)
    y = rand.float32_range(10, 800)
    append(&forests, Tile{{x, y, f32(100), f32(100)}, "forest", texture3})
 }
...
spread :: proc( water: [dynamic; 10]Tile, farms: [dynamic; 50]Tile, forests: [dynamic; 50]Tile ){
for tile in water {
    tile.rect.x += x_velocity
}
}