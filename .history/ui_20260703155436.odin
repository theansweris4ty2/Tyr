...
draw_ui ::proc(menu: Menu, buttons: [dynamic; 6]Button, index1: i32, index2: i32, index3: i32, action1: i32, action2: i32, action3: i32, stats: Menu, player: Player){
    ...
    rl.DrawRectangle_outline(button.rect, 1, rl.BLACK)
    } 
    ...
    rl.DrawRectangle({button.rect.x, button.rect.y, button.rect.w, button.rect.h}, button.color)
    ...
    rl.DrawRectangle_outline(menu.rect, menu.border, rl.BLACK)
    rl.draw_text(menu.label, {menu.rect.x + 50, menu.rect.y + 10}, 70, rl.BLACK)
    rl.DrawRectangle_outline(stats.rect, stats.border, rl.BLACK)
