...
menu1: Menu = {{200, 200, 400, 400}, {Button{{menu1.rect.x + 10, menu, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{520, 0, 200, 50}, WHEAT_GOLD, "Battle", 50}, Button{{740, 0, 200, 50}, WHEAT_GOLD, "Quit", 75}}}
