...
draw_ui :: proc(){
    buttons: [3]Button = {Button{{100, 400, 200, 50}, rl.DARKGREY, "New Game", 30}, Button{{350, 400, 200, 50}, rl.DARKGRAY, "Saved Game", 10}, Button{{600, 400, 200, 50}, rl.DARKGRAY, "Quit", 75}}
