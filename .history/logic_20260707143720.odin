...
/* TODO: Add UI for player action choices and then separate it out into different actions listed below alter the logic in the current player action proc for other purposes, e.g. 
*/
