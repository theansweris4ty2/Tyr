...
camera_movement :: proc(camera: ^rl.Camera2D, map_) -> rl.Vector2{
...
draw_toolbar :: proc(toolbar: Toolbar){
    rl.DrawRectangle(i32(toolbar.rect.x), i32(toolbar.rect.y), i32(toolbar.rect.width), i32(toolbar.rect.height), rl.BEIGE)
