...
for &tile in farm_tiles {
    ...
    for &next_tile in farm_tiles {
        if tile.rect.x + tile.rect.w >= next_tile.x && tile.rect.x <= next_tile.rect.x + next_tile.w && tile.rect.y + tile.rect.h >= next_tile.rect.y && tile.rect.y <= next_tile.rect.y + next_tile.h {
