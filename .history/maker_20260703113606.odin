...
generate_map :: proc(texture: k2.Texture)-> Board{
game_board: Board
for row, i in game_board {
    for column, j in row {
        append(&game_board.row,  Tile{{f32(24 % i * TILE_WIDTH), f32(24/i * TILE_HEIGHT), f32(TILE_WIDTH), f32(TILE_HEIGHT)}, "farm", texture, 0, 0 })
    }
}
