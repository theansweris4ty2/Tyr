...
draw_ui :: proc(){
    buttons: [3]Button = {Button{{100, 400, 200, 50}, WHEAT_GOLD, "New Game", 30}, Button{{350, 400, 200, 50}, rl.DARKBROWN, "Saved Game", 10}, Button{{600, 400, 200, 50}, rl.DARKBROWN, "Quit", 75}}
