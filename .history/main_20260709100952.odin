...
toolbar: Toolbar = {{0, 0, WINDOW_WIDTH, 50}, {Button{{10, 0, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{220, 0, 200, 50}, WHEAT_GOLD, "Battle", 10}, Button{{430, 0, 200, 50}, WHEAT_GOLD, "Quit", 75}}}
