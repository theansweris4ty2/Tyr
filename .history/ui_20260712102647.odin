...
menu_buttons: [dynamic; 20]Button = {Button{{menu1_rect.x + 10, menu1_rect.y + 10, 200, 50}, WHEAT_GOLD, "Main Menu", 30}, Button{{menu1_rect.x + 10, menu1_rect.y + 70, 200, 50}, WHEAT_GOLD, "Battle", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 130, 200, 50}, WHEAT_GOLD, "Quit", 75}, Button{{menu1_rect.x + 10, menu1_rect.y + 190, 200, 50}, WHEAT_GOLD, "Produce", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 250, 200, 50}, WHEAT_GOLD, "Recruit", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 310, 200, 50}, WHEAT_GOLD, "Build", 50}, Button{{menu1_rect.x + 10, menu1_rect.y + 3, 200, 50}, WHEAT_GOLD, "Spy", 50}}
