...
player_action :: proc(tile_map: [dynamic]Tile, player_ptr: ^Player, point: rl.Vector2, action: string, town_texture: rl.Texture2D, menu: bool, infantry: rl.Texture, crossbow: rl.Texture, cavalry: rl.Texture, unit: string){
