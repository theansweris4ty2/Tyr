...
draw_ui :: proc(){
    buttons: [3]Button = {Button{{100, 400, 200, 50}, rl.RED, "New Game", 30}, Button{{350, 400, 200, 50}, rl.RED, "Saved Game", 10}, Button{{600, 400, 200, 50}, rl.RED, "Quit", 75}}
    for button in buttons {
        rl.DrawText("TYR", 400, 200, 100, rl.DARKBROWN)
        rl.DrawRectangleRounded({i32(button.rect.x), i32(button.rect.y), i32(button.rect.width), i32(button.rect.height)},5, 2, button.color)
