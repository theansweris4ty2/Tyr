...
recruit :: proc(player_ptr: ^Player, unit: string, texture1: rl.Texture, texture2: rl.Texture, texture3: rl.Texture){
    
    switch unit {
        case "Infantry":
            append(&player_ptr.troops, Troop_Tile{{}, texture1, 2, 1, "infantry", 2})
        case "Crossbow":
            append(&player_ptr.troops, Troop_Tile{{}, texture1, 2, 1, "crossbow", 2})
        case "Cavalry":
            append(&player_ptr.troops, Troop_Tile{{}, texture1, 2, 1, "cavalry", 5})
    }
    troop:= Troop_Tile{}
