...
for &tile in tile_map{
    for i in 0..=len(tile_map) -2 {
        if i.rect.x + i.rect.w >= tile_map[i+1].rect.x && i.rect.x <= tile_map[i+1].rect.x + tile_map[1+1].rect.w && i.rect.y + i.rect.h >= tile_map[i+1].rect.y && i.rect.y <= next_tile.rect.y + next_tile.rect.h {
    // //         tile.x_velocity = 0
    // //         tile.y_velocity = 0
    // //         next_tile.y_velocity = 0
    // //         next_tile.x_velocity = 0
