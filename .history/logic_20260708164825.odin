...
draw_ui :: proc(){
    buttons: [3]Button = {Button{{200, 200, 150, 50}, rl.RED, "New Game"}, Button{{550, 200, 100, 50}, rl.RED, "Saved Game"}, Button{{700, 200, 150, 50}, rl.RED, "Quit"}}
    rl.ClearBackground(rl.DARKGRAY)
    for button in buttons {
        rl.DrawRectangle(i32(button.rect.x), i32(button.rect.y), i32(button.rect.width), i32(button.rect.height), button.color)
        rl.DrawText(button.label, i32(button.rect.x + 10), i32(button.rect.y +10), 20, rl.BLACK)
    }
}
