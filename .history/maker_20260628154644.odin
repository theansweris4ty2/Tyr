...
seed :: proc(texture: k2.Texture, texture2: k2.Texture) -> ([dynamic; 10]Tile, [dynamic; 50]Tile, [dynamic; 50]Tile){
...
for i in 0..=9 {
 ...
 for i in 0..=49 {
    ...
    x = rand.float32_range(10, 1000)
    y = rand.float32_range(10, 800)
    append(&farms, Tile{{x, y, f32(100), f32(100)}, "farms", texture2})
    x = rand.float32_range(10, 1000)
    y = rand.float32_range(10, 800)
    append(&farms, Tile{{x, y, f32(100), f32(100)}, "forest", texture2})
 }
