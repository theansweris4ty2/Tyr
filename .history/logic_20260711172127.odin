...
player_action :: proc(tile_map: [dynamic]Tile, player_ptr: ^Player, point: rl.Vector2, player_action: string) -> ^Tile{
...
player_stats:= fmt.tprintf("grain: %d Lumber: %d Ore: %d ", player_ptr.grain, player_ptr.lumber, player_ptr.ore)
