...
seed :: proc(texture: k2.Texture, texture2: k2.Texture, texture3: k2.Texture) -> ([dynamic; 0]Tile, [dynamic; 15]Tile, [dynamic; 45]Tile){
...
for i in 0..<8 {
 ...
 for i in 0..<45 {
    x = rand.float32_range(200, 1500)
    y = rand.float32_range(200, 800)
